...
namespace Trivia
{
    public class Game
    {
        ...
        private readonly int[] _places = new int[MaximumNumberOfPlayers];
        private readonly int[] _purses = new int[MaximumNumberOfPlayers];
        private readonly bool[] _inPenaltyBox = new bool[MaximumNumberOfPlayers];
